...
const questions = [
  ...
  {
    key: "teenPriority",
    title: "מה חשוב לנער/ה בטיול?",
    helper: "זו שכבה עדינה בתכנון — כדי שהמסלול יהיה מהנה גם עבורו/ה, בלי להפוך את זה לנושא המרכזי.",
    options: [
      "קניות, שווקים ומתנות",
      "שוקולד, קינוחים ובתי קפה",
      "תמונות, אורות ונופים יפים",
      "שלג וחוויות חורף",
      "זמן חופשי ומסלול לא עמוס מדי",
    ],
  },
] as const;
const teenOptions = [
